...
public class RangedArm : MonoBehaviour
{
	...
	private void Update()
	{
		if (GetComponentInParent<Enemy>().stunned)
		{
			return;
		}
		if (arm.flipX)
		{
			base.transform.localPosition = new Vector3(0.074f, 0.134f, 0f);
			arm.transform.localPosition = new Vector3(-0.074f, -0.134f, 0f);
		}
		else
		{
			base.transform.localPosition = new Vector3(-0.074f, 0.134f, 0f);
